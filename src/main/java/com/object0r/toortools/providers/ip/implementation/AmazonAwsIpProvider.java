...
public class AmazonAwsIpProvider extends AbstractIpProvider
{
    @Override
    ...
    public String getIp(Proxy proxy, int connectTimeoutSeconds, int readTimeoutSeconds) throws InvalidProviderException
    {
        try
        {
            String ip=   readUrl("http://checkip.amazonaws.com/", proxy, connectTimeoutSeconds, readTimeoutSeconds);
